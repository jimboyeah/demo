...
{
    public partial class GameOfLife : ContentPage
    {
        const int MaxCellSize = 90;
        const int CellSpacing = 2;

        const int MaxCellCount = 300;
        ...
        void UpdateLayout()
        {
            ...
            while (absoluteLayout.Children.Count < count)
            {
                ...
                lifeCell.Swiped += OnSwiped;
                lifeCell.PinchUpdated += OnPinchUpdated;
