...
#include <afxext.h>
#include "..\..\mfc_static\mfc_staticDoc.h"
#include "..\..\mfc_static\mfc_staticView.h"
...
protected:
	...
	DECLARE_DOCUMENT(CmfcstaticDoc)
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CmfcstaticView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CmfcstaticDoc, (CObject*) m_pDocument->GetContainer());
